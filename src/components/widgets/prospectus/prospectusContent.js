...
export const sponsorshipDetails = [
  {
    ...
    items: [
      ...
      "Strengthen your brand's association with Python and the open-source community.",
      'Increase your visibility within the local tech ecosystem and beyond.',
    ],
  },
  {
    ...
    items: [
      ...
      'Identify potential collaborators and recruits from among the attendees.',
      'Forge connections with startups, agencies, and other tech-driven organizations.',
    ],
  },
  {
    ...
    items: [
      ...
      'Support an inclusive event that promotes learning and collaboration.',
      'Help make the event accessible to a broad audience by keeping participation fees low.',
    ],
  },
];
...
export const sponsorshipPackages = [
  {
    ...
    benefits: [
      ...
      '1 complimentary event pass for your team or guests.',
      'Inclusion in the official event recap on the DurianPy blog.',
    ],
  },
  {
    ...
    price: 15000,
    benefits: [
      'Prominent logo placement on the event website, select promotional materials, and event signage.',
      'Recognition as a Gold Sponsor during the event, including in the official event communications.',
  ...
  },
  {
    ...
    price: 30000,
    benefits: [
      'Top-tier logo placement on the event website, promotional materials, and event signage.',
      'Recognition as a Platinum Sponsor in all event communications, including opening and closing remarks.',
